...
Write-Host ""
Write-Host "You can close this window and click Refresh in OpenClaw Desktop." -ForegroundColor Cyan
Write-Host ""
...
echo ""
echo "You can close this window and click Refresh in OpenClaw Desktop."
...
Write-Host ""
Write-Host "Please restart OpenClaw Desktop after installation" -ForegroundColor Green
Write-Host ""
Read-Host "Press Enter to close this window"
' -Verb RunAs
"#;
